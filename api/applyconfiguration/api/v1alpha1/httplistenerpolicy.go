...
func (b *HTTPListenerPolicyApplyConfiguration) WithStatus(value apisv1.PolicyStatus) *HTTPListenerPolicyApplyConfiguration {
	b.Status = &value
	return b
}

// GetKind retrieves the value of the Kind field in the declarative configuration.
func (b *HTTPListenerPolicyApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *HTTPListenerPolicyApplyConfiguration) GetAPIVersion() *string {
...
func (b *HTTPListenerPolicyApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
