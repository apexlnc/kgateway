...
func (b *DirectResponseApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *DirectResponseApplyConfiguration) GetAPIVersion() *string {
...
func (b *DirectResponseApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
